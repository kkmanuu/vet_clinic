...
- [:List: Veterinary Clinic](#-Awesome-a-nameabout-projecta)
  ...
  - [:memo: License ](#-license-a-namelicensea)
   ...
   # :book: Veterinary Clinic <a name="about-project"></a>
  - A PostgreSQL database workflow for the veterinary clinic.
...
Contributions, issues [page issues](https://github.com/kkmanuu/vet_clinic/issues), and feature requests are welcome!
<p align="right">(<a href="#readme-top">back to top</a>)</p>
